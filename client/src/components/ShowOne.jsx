            ...
            <div className="w-full px-4 md:w-1/2 ">
              <div className="sticky top-0 z-50 overflow-hidden ">
                ...
                <div className="flex-wrap hidden md:flex ">
                  <div className="w-1/2 p-2 sm:w-1/2">
                    <a
                      href="#"
                      className="block border border-red-300 dark:border-transparent dark:hover:border-red-300 hover:border-red-300"
                    >
                      <img
            ...
            <div className="w-full px-4 md:w-1/2  ">
              ...
              <div className="lg:pl-20 ">
                <div className="mb-8 ">
                  ...
                  <h2 className="max-w-xl mt-2 mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl uppercase">
                    {oneProduct.type}
                  </h2>
                ...
                <div className="w-32 mb-8 ">
                  ...
                  <div className="relative flex flex-row w-full h-10 mt-4 bg-transparent rounded-lg">
                    <button onClick={() => decQ()} className="w-20 h-full text-gray-600 bg-gray-300 rounded-l outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 hover:text-gray-700 dark:bg-gray-900 hover:bg-gray-400">
                    ...
                    <input
                      ...
                      value={q}
                    />
                    <button onClick={() => incQ()} className="w-20 h-full text-gray-600 bg-gray-300 rounded-r outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 dark:bg-gray-900 hover:text-gray-700 hover:bg-gray-400">
                      <span className="m-auto text-2xl font-thin">+</span>
                    </button>
                  </div>
                </div>
